...
public:
    ...
    inline static const std::string id="FIRST_STATE";
...
public:
    ...
    inline  static const std::string id="DYNAMIC_COMMAND_QUEUE";
    virtual void execute(std::string command, std::string time) final override
    {
        if(command=="EOF")
        {
...
public:
    ...
    inline static const std::string id="DYNAMIC_COMMAND_QUEUE_NESTED_BLOCK";
    virtual void execute(std::string command, std::string time) final override
    {
        if(command=="EOF")
        {
